...
CREATE TABLE act (
    ...
    comments citext DEFAULT ''::citext NOT NULL
);
...
CREATE TABLE image (
    ...
    title citext DEFAULT ''::citext NOT NULL,
    performancedate date DEFAULT '1900-01-01'::date NOT NULL,
    locationid citext DEFAULT ''::citext NOT NULL,
    comments citext DEFAULT ''::citext NOT NULL
);
...
CREATE TABLE piece (
    ...
    audiopath citext DEFAULT ''::citext NOT NULL,
    videopath citext DEFAULT ''::citext NOT NULL,
    comments citext DEFAULT ''::citext NOT NULL
);
...
CREATE TABLE set (
    ...
    locationid citext NOT NULL,
    setno integer NOT NULL,
    actname citext DEFAULT ''::citext NOT NULL,
    comments citext DEFAULT ''::citext NOT NULL
);
