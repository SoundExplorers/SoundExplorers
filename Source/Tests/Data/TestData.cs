...
public class TestData {
  ...
  [PublicAPI] public Schema Schema { get; set; } = null!;
  ...
  [PublicAPI] public IList<UserOption> UserOptions { get; }
  ...
  public static int GetRandomInteger(int fromInclusive, int toInclusive) {
    return RandomNumberGenerator.GetInt32(fromInclusive, toInclusive + 1);
  }
