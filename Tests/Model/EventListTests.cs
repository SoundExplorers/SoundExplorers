...
namespace SoundExplorers.Tests.Model {
  ...
  public class EventListTests {
    ...
    public void DefaultEventType() {
      ...
      Assert.AreEqual(EventType.DefaultName, defaultEventType.Name,
    ...
    public void DisallowDuplicateKey() {
      ...
      bindingList.AddNew();
      List.OnRowEnter(4);
      otherEvent = Data.Events[1];
      bindingList[4].Date = otherEvent.Date;
    ...
    public void GetIdentifyingParentAndChildrenForMainList() {
      ...
      Assert.IsInstanceOf<Set>(identifyingParentAndChildren.Children[0], "Child type");
    }
  }
}