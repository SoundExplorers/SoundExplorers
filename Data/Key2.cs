...
namespace SoundExplorers.Data {
  ...
  /// </remarks>
  public class Key2 {
    private readonly IEntity2? _identifyingParent;
    ...
    /// </summary>
    /// <param name="owner">
    ///   The entity whose Key2 property is set to this key.
    /// </param>
    ...
    /// </param>
    internal Key2(IEntity2 owner,
      IEntity2? identifyingParent = null) {
      Owner = owner;
    ...
    /// <summary>
    ///   Use this constructor for a Key2 that can be used for comparisons with Keys that
    ...
    /// </param>
    public Key2(string simpleKey,
      IEntity2? identifyingParent) {
      _simpleKey = simpleKey;
      _identifyingParent = identifyingParent;
    }

    private IEntity2? IdentifyingParent =>
      Owner?.IdentifyingParent ?? _identifyingParent;

    private IEntity2? Owner { get; }
    ...
    public override int GetHashCode() {
      ...
      //   ? IdentifyingParent.Key2.GetHashCode()
      //   : 0;
      // return hashCode1 + hashCode2;
    }

    public static bool operator ==(Key2? key1, Key2? key2) {
