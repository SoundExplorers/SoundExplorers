...
namespace SoundExplorers {
    ...
    public partial class MdiParentForm : Form {
        ...
        private EventShortcutList EventShortcuts { get; set; }
        private bool RWinIsDown { get; set; }
        private SelectTableForm SelectTableForm { get; set; }
        private SizeableFormOptions SizeableFormOptions { get; set; }
        private Option StatusBarOption { get; set; }
        private Option TableOption { get; set; }
        private Option ToolBarOption { get; set; }
                ...
                foreach (ToolStripItem dropDownItem in menu.DropDownItems) {
                    ...
                    if (menuItem != null) {
                        if (menuItem.ShortcutKeys.HasFlag(Keys.Control)) {
                            Keys letterKeyCode = (Keys)(menuItem.ShortcutKeys - Keys.Control);
                            result.Add(new EventShortcut(letterKeyCode, menuItem, "Click"));
                            menuItem.ShortcutKeyDisplayString = "⌘+" + letterKeyCode.ToString();
                        }
                    }
                }//End of foreach
            }//End of foreach
