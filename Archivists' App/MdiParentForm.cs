...
namespace SoundExplorers {
  public partial class MdiParentForm : Form {
    ...
    private void
      ArrangeIconsToolStripMenuItem_Click(object sender, EventArgs e) {
    ...
    private void TileSideBySideToolStripMenuItem_Click(object sender,
      EventArgs e) {
      LayoutMdi(MdiLayout.TileVertical);
    }

    private void
      TileStackedToolStripMenuItem_Click(object sender, EventArgs e) {
