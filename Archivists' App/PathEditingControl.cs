...
namespace SoundExplorers {
    ...
    internal class PathEditingControl : UserControl, IDataGridViewEditingControl {
        ...
        private string FileType { 
            get {
                return EditingControlDataGridView.CurrentCell.OwningColumn.Name.Replace(
                        "Path", string.Empty);
            } 
        }
        ...
        protected void RenderControl() {
            ...
            Button.Width = 32;
            Button.Location = new Point(this.Width -32, 0);
        ...
        private void Button_GotFocus(object sender, EventArgs e) {
            ...
            openFileDialog.Title = ("Select " + FileType + " File").Replace("  ", " ");
            string path = EditingControlFormattedValue.ToString();
                ...
                || !folder.Exists) {
                    ...
                    case "Path":
                        if (pathCell.Column.TableName == "Image") {
                            folder = SoundExplorers.Data.Image.DefaultFolder; // Image.Path
                        } else if (pathCell.Column.TableName == "Newsletter") { // Newsletter.Path
