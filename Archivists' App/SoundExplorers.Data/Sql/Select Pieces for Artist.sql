...
FROM Credit
INNER JOIN Piece
	ON Piece.PerformanceDate = Credit.PerformanceDate
	and Piece.LocationId = Credit.LocationId
	and Piece.SetNo = Credit.SetNo
	and Piece.PieceNo = Credit.PieceNo
INNER JOIN "set"
