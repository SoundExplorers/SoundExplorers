...
namespace SoundExplorers.Data {
  ...
  public abstract class OurSqlCommand<T> : PgSqlCommand
    ...
    /// </summary>
    private bool WereParametersGenerated { get; set; }
    ...
    ///   field properties.
    /// </summary>
    protected IEntityColumnList Columns { get; }
    ...
    // /// </summary>
    // private IEntityColumnList NonPrimaryKeyColumns { get; }
    ...
    ///   the primary key required for database access.
    /// </summary>
    protected IEntityColumnList PrimaryKeyColumns { get; }
    ...
    protected virtual string SqlFilename {
      get {
        if (_sqlFilename == null) {
          _sqlFilename =
            SqlTypeName + " " + EntityType.Name + ".sql";
        }
        return _sqlFilename;
      }
    ...
    ///   represented by the derived class.
    /// </summary>
    protected virtual string SqlTypeName { get; }
    ...
    private string[] GetParameterPlaceholders() {
      ...
      var characterIsInPlaceholder = false;
      ...
      foreach (char character in CommandText.TrimEnd()) {
    ...
    /// <param name="type">
    ///   A .Net type,
    ///   in this cas the type one of the listed Entity's field properties.
    /// </param>
    /// <returns>
    ...
    private void ValidateParameterPlaceholders() {
      var placeholders = GetParameterPlaceholders();
