...
namespace SoundExplorers.Data {
    ...
    internal class SqlHelper {
        ...
        public static readonly string ConnectionString =
            ...
            "User ID=fred;" +
            "Password=!q";
        private PgSqlCommand _command = null;
        ...
        public virtual void DeleteAllFromTable(string tableName) {
            ...
            try {
                this.Execute("Truncate Table.sql", parameters);
            } catch {
                this.Execute("Delete From Table.sql", parameters);
            }
        }
        ...
        public virtual void DropTableIfExists(string tableName) {
            var parameters = new Dictionary<string, string>(1);
            parameters.Add("#TableName", tableName);
            this.Execute("Drop Table If Exists.sql", parameters);
        }
        ...
        //private string GetEmbeddedText(
            ...
            StringBuilder builder = new StringBuilder(embeddedText);
