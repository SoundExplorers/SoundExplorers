    ...
    internal class PieceAudioTags : IAudioTags {
        ...
        public string Artist { 
            get {
                ...
                for (int i = 0; i < Piece.Credits.Count; i++) {
        ...
        public string Comment { 
            get {
                ...
                if (Piece.Credits.Count > 0) {
                    comment.Write(Piece.Credits[0].Artist + " - " + Piece.Credits[0].Role);
                    string lastArtist = Piece.Credits[0].Artist;
                    if (Piece.Credits.Count > 1) {
                        for (int i = 1; i < Piece.Credits.Count; i++) {
                            Credit credit = Piece.Credits[i];
