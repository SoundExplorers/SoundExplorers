...
namespace SoundExplorers {
    ...
    public class SplashManager {
        ...
        #region Fields
        private static bool _isSplashFormBeingShown = false;
        /// <summary>
        /// The splash form.
        /// </summary>
        ...
        public static bool Visible {
            get {
                return _splashForm != null && _splashForm.Visible;
            }
        }
        ...
        public static void Show(Type splashFormType, params object[] args) {
            ...
            _args = args;
            _splashThread = new Thread(new ThreadStart(SplashManager.ShowThread));
        ...
        public static DialogResult ShowMessageBox(
                ...
                MessageBoxButtons buttons,
                MessageBoxIcon icon) {
            if (SplashManager.Visible) {
                // The splash window is shown on a separate thread.
                // So we need to do a cross-thread invokation.
                if (SplashManager.SplashForm.InvokeRequired) {
                    return (DialogResult)SplashManager.SplashForm.Invoke(
                        new ShowMessageBoxDelegate(ShowMessageBox),
                        new object[] { text, caption, buttons, icon });
                }
            }
            if (SplashManager.Visible) {
                ...
                // focus.
                SplashManager.SplashForm.Activate();
            }
