...
namespace SoundExplorers {
    ...
    internal class ComboBoxCell : DataGridViewTextBoxCell {
        ...
        private ComboBoxEditingControl ComboBox {
            get {
                return DataGridView.EditingControl as ComboBoxEditingControl;
            }
        }
        ...
        public override void InitializeEditingControl(
            ...
            if (ValueType == typeof(string)) {
                ...
                ComboBox.SelectedIndex = ComboBox.FindStringExact(initialFormattedValue.ToString());
            } else { // DateTime
                if (referencedEntities.Count > 0) {
                    PopulateDateDropDownList(
                        initialFormattedDate: initialFormattedValue.ToString(),
                        referencedEntities: referencedEntities);
                } else {
                    ComboBox.DataSource = null;
                    ThrowNoAvailableReferencesException(parentColunnName, parentColunnValue);
                }
            }
        }
        ...
        private void PopulateDateDropDownList(
            ...
            var dictionary = new Dictionary<string, DateTime>(referencedEntities.Count);
            ...
            if (ComboBox.SelectedIndex == -1) {
                DateTime firstDate =
                    (DateTime)referencedEntities.Table.Rows[0][Column.ReferencedColumnName];
        ...
        /// gets raised.
        /// </remarks>
        private void ThrowNoAvailableReferencesException(string parentColunnName, object parentColunnValue) {
            string message =
