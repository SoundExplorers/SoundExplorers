...
namespace SoundExplorers {
    ...
    internal class EventShortcut {
        ...
        /// </summary>
        private Delegate[] Subscribers { get; set; }
        ...
        public void RaiseEvent(EventArgs e) {
            ...
            foreach (Delegate subscriber in Subscribers) {
                if (subscriber.Target is Control) {
                    Control control = (Control)subscriber.Target;
            ...
            do {
                ...
                foreach (FieldInfo field in fields) {
                    if (field.Name == EventName) {
                        ...
                        Delegate eventDelegate = field.GetValue(Target) as Delegate;
                    ...
                    if (field.Name == winFormsEventName) {
                        ...
                        //get the list
                        EventHandlerList eventHandlers = (EventHandlerList)Target.GetType().GetProperty(
                            "Events",
                        ...
                        Delegate eventDelegate = eventHandlers[field.GetValue(Target)];
                        if (eventDelegate != null)
                            return eventDelegate.GetInvocationList();
                    }
                }
